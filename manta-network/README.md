...
![manta-network](media/avatar.png)
...
Manta Pacific is a Web3 ecosystem built on the Manta Network, focusing on providing privacy-preserving infrastructure and applications. It aims to enable scalable, private on-chain interactions and DeFi services while maintaining user confidentiality.

## 🔗 Links

- **Website**: https://manta-network.com
- **GitHub**: https://github.com/Manta-Network/manta-rs
