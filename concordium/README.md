...
A privacy-focused, public, and permissionless Layer-1 blockchain with protocol-level identity verification, zero-knowledge proofs, and built-in compliance features. First blockchain with built-in identity verification at the protocol level.
...
**Repository**: [https://github.com/Concordium/concordium-node](https://github.com/Concordium/concordium-node)

- **Total Lines of Code**: 22,278
- **Total Files**: 562
- **Smart Contracts**: 0
- **Test Files**: 145
