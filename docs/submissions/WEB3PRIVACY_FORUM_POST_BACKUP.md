...
- 🕵️ [Mysterium Network OSINT data](https://github.com/M0nkeyFl0wer/web3-privacy-ethereum-cypherpunk-research/blob/master/deliverables/mysterium-network/analysis/osint_data.json) (2,212 lines - infrastructure & team OPSEC)
- ⛓️ [Tornado Cash smart contracts](https://github.com/M0nkeyFl0wer/web3-privacy-ethereum-cypherpunk-research/blob/master/deliverables/tornado-cash/analysis/smart_contracts.json) (on-chain data)
...
### Projects Awaiting Research (47 total)
