...
Scroll Name Service (SNS) is a decentralized naming system on the Scroll network. It allows users to register human-readable names that resolve to Scroll addresses, enabling easier transactions and identity management on the blockchain.
...
- **Total Lines of Code**: 36,344
- **Primary Language**: Go
- **Smart Contracts**: 1 Solidity files
- **Test Coverage**: 78 test files
