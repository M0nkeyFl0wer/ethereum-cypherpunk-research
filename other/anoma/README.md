...
**Repository**: [https://github.com/anoma/anoma](https://github.com/anoma/anoma)

- **Total Lines of Code**: 0 *(Note: language detection incomplete)*
- **Total Files**: 392
- **Smart Contracts**: 0
- **Test Files**: 65
...
*Language file counts unavailable (analysis detected 0 files across all languages)*
